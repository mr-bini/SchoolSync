...
urlpatterns = [
    ...
    # Dev/test helpers
    path('notifications/seed', notifications_seed_for_user, name='notifications_seed_for_user'),
    path('notifications/seed_all', notifications_seed_all, name='notifications_seed_all'),
    path('notifications/create', notifications_create, name='notifications_create'),
    path('notifications/mark_all_read', notifications_mark_all_read, name='notifications_mark_all_read'),
    path('notifications/trigger_event_sweep', notifications_trigger_event_sweep, name='notifications_trigger_event_sweep'),
]
